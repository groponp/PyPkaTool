...
| `--keep-hetatoms` | off | Keep waters/ions/ligands/other non-polymer `HETATM` records, scoped to whatever `--select-chains` kept; by default they are dropped (protein/DNA/RNA only) |
